module simd_compute_forces_viscoelastic_bindings
   use, intrinsic :: iso_c_binding
   implicit none

   interface
    subroutine dumm_loc_simd(displ_p,eta,veloc_p,dummyx_loc_p,dummyy_loc_p,dummyz_loc_p) bind(C, name="dumm_loc_simd")
       import :: c_float, c_ptr
       type(c_ptr), value :: displ_p,veloc_p
       type(c_ptr), value :: dummyx_loc_p,dummyy_loc_p,dummyz_loc_p
       real(c_float),value :: eta
    end subroutine dumm_loc_simd
   end interface

   interface
    subroutine temp_simd(dummyx_loc_p,dummyy_loc_p,dummyz_loc_p,hp,tempx,tempy,tempz) bind(C, name="temp_simd")
       import :: c_float, c_ptr
       type(c_ptr), value :: dummyx_loc_p,dummyy_loc_p,dummyz_loc_p
       real(c_float),intent(inout) :: hp,tempx,tempy,tempz
    end subroutine temp_simd
   end interface

   interface
    subroutine dumm_loc_simd_2(deltat,veloc_p,dummyx_loc_p,dummyy_loc_p,dummyz_loc_p) bind(C, name="dumm_loc_simd_2")
       import :: c_float, c_ptr
       type(c_ptr), value :: veloc_p
       type(c_ptr), value :: dummyx_loc_p,dummyy_loc_p,dummyz_loc_p
       real(c_float),value :: deltat
    end subroutine dumm_loc_simd_2
   end interface

   interface
    subroutine du_simd(xixl,xiyl,xizl,etaxl,etayl,etazl,gammaxl,gammayl,gammazl,tempx1,tempx2,tempx3,&
                    duxdxl,duxdyl,duxdzl,tempy1,tempy2,tempy3,duydxl,duydyl,duydzl,tempz1,tempz2,tempz3,&
                    duzdxl,duzdyl,duzdzl) bind(C, name="du_simd")
       import :: c_ptr
       type(c_ptr), value :: xixl,xiyl,xizl,etaxl,etayl,etazl,gammaxl,gammayl,gammazl,tempx1,tempx2,tempx3
       type(c_ptr), value :: duxdxl,duxdyl,duxdzl,tempy1,tempy2,tempy3,duydxl,duydyl,duydzl,tempz1,tempz2,tempz3
       type(c_ptr), value :: duzdxl,duzdyl,duzdzl
    end subroutine du_simd
   end interface

  interface
    subroutine stresses_simd(c11,c12,c13,c14,c15,c16,c22,c23,c24,c25,c26,c33,c34,c35,c36,c44,c45,c46,c55,c56,c66,&
        duxdyl_p,duydxl_p,duzdxl_p,duxdzl_p,duzdyl_p,duydzl_p,duxdxl_p,duydyl_p,duzdzl_p,kappal,mul,FOUR_THIRDS,&
        R_xx_sum,R_yy_sum,R_trace_kappa_sum,R_xy_sum,R_xz_sum,R_yz_sum,ATTENUATION,ANISOTROPY,is_CPML,&
        MOVIE_VOLUME_STRESS,stress_xx_p,stress_yy_p,stress_zz_p,stress_xy_p,stress_xz_p,stress_yz_p,ispec_irreg,&
        xixl,xiyl,xizl,etaxl,etayl,etazl,gammaxl,gammayl,gammazl,jacobianl,tempx1,tempx2,tempx3,tempy1,tempy2,tempy3,&
        tempz1,tempz2,tempz3,jacobian_regular,xix_regular) bind(C, name="stresses_simd")
       import :: c_ptr,c_bool,c_float,c_int
       type(c_ptr), value :: c11,c12,c13,c14,c15,c16,c22,c23,c24,c25,c26,c33,c34,c35,c36,c44,c45,c46,c55,c56,c66
       type(c_ptr), value :: duxdyl_p,duydxl_p,duzdxl_p,duxdzl_p,duzdyl_p,duydzl_p,duxdxl_p,duydyl_p,duzdzl_p,kappal,mul
       type(c_ptr), value :: R_xx_sum,R_yy_sum,R_trace_kappa_sum,R_xy_sum,R_xz_sum,R_yz_sum
       type(c_ptr), value :: stress_xx_p,stress_yy_p,stress_zz_p,stress_xy_p,stress_xz_p,stress_yz_p
       type(c_ptr), value :: xixl,xiyl,xizl,etaxl,etayl,etazl,gammaxl,gammayl,gammazl,jacobianl
       type(c_ptr), value :: tempx1,tempx2,tempx3,tempy1,tempy2,tempy3,tempz1,tempz2,tempz3
       logical(c_bool), value :: is_CPML,ATTENUATION,ANISOTROPY,MOVIE_VOLUME_STRESS
       real(c_float),value :: FOUR_THIRDS,jacobian_regular,xix_regular
       integer(c_int),value :: ispec_irreg
    end subroutine stresses_simd
   end interface

   interface
    subroutine mxm5_3comp_singleA_simd(A,n1,B1,B2,B3,C1,C2,C3,n3) bind(C, name="mxm5_3comp_singleA_simd")
       import :: c_ptr,c_int
       type(c_ptr), value :: A,B1,B2,B3,C1,C2,C3
       integer(c_int),value :: n1,n3
      end subroutine mxm5_3comp_singleA_simd
   end interface

   interface
    subroutine mxm5_3comp_singleB_simd(A1,A2,A3,n1,B,C1,C2,C3,n3) bind(C, name="mxm5_3comp_singleB_simd")
       import :: c_ptr,c_int
       type(c_ptr), value :: A1,A2,A3,B,C1,C2,C3
       integer(c_int),value :: n1,n3
      end subroutine mxm5_3comp_singleB_simd
   end interface

   interface
    subroutine mxm5_3comp_3dmat_single_simd(A1,A2,A3,n1,B,n2,C1,C2,C3,n3) bind(C, name="mxm5_3comp_3dmat_single_simd")
       import :: c_ptr,c_int
       type(c_ptr), value :: A1,A2,A3,B,C1,C2,C3
       integer(c_int),value :: n1,n2,n3
      end subroutine mxm5_3comp_3dmat_single_simd
   end interface
...
#include "config.fh"
  ...
  USE simd_compute_forces_viscoelastic_bindings
  ...
  real(kind=CUSTOM_REAL), dimension(NDIM,NGLOB_AB),intent(in) ,target :: displ,veloc
...
! local parameters
  ...
  real(kind=CUSTOM_REAL), dimension(NGLLX,NGLLY,NGLLZ) ,target:: dummyx_loc,dummyy_loc,dummyz_loc
  real(kind=CUSTOM_REAL), dimension(NGLLX,NGLLY,NGLLZ) ,target:: tempx1,tempx2,tempx3
  real(kind=CUSTOM_REAL), dimension(NGLLX,NGLLY,NGLLZ) ,target:: tempy1,tempy2,tempy3
  real(kind=CUSTOM_REAL), dimension(NGLLX,NGLLY,NGLLZ) ,target:: tempz1,tempz2,tempz3
  real(kind=CUSTOM_REAL), dimension(NGLLX,NGLLY,NGLLZ) ,target:: newtempx1,newtempx2,newtempx3
  real(kind=CUSTOM_REAL), dimension(NGLLX,NGLLY,NGLLZ) ,target:: newtempy1,newtempy2,newtempy3
  real(kind=CUSTOM_REAL), dimension(NGLLX,NGLLY,NGLLZ) ,target:: newtempz1,newtempz2,newtempz3
  ...
  real(kind=CUSTOM_REAL), dimension(NGLLX,NGLLY,NGLLZ) ,target:: dummyx_loc_att,dummyy_loc_att,dummyz_loc_att
  real(kind=CUSTOM_REAL) ,target:: duxdxl_att,duxdyl_att,duxdzl_att,duydxl_att
  real(kind=CUSTOM_REAL) ,target:: duydyl_att,duydzl_att,duzdxl_att,duzdyl_att,duzdzl_att
  real(kind=CUSTOM_REAL) :: duxdyl_plus_duydxl_att,duzdxl_plus_duxdzl_att,duzdyl_plus_duydzl_att

  real(kind=CUSTOM_REAL), dimension(NGLLX,NGLLY,NGLLZ) ,target:: duxdxl,duxdyl,duxdzl,duydxl,duydyl,duydzl,duzdxl,duzdyl,duzdzl

  real(kind=CUSTOM_REAL) :: tempx1l,tempx2l,tempx3l
  real(kind=CUSTOM_REAL) :: tempy1l,tempy2l,tempy3l
  real(kind=CUSTOM_REAL) :: tempz1l,tempz2l,tempz3l

  real(kind=CUSTOM_REAL) ,target:: xixl,xiyl,xizl,etaxl,etayl,etazl,gammaxl,gammayl,gammazl,jacobianl
  ...
  real(kind=CUSTOM_REAL) ,target:: lambdal,mul,lambdalplus2mul
  real(kind=CUSTOM_REAL) ,target:: kappal
  ...
  real(kind=CUSTOM_REAL), dimension(NGLLX,NGLLY,NGLLZ) ,target:: R_trace_kappa_sum,R_xx_sum,R_yy_sum,R_xy_sum, &
          R_xz_sum,R_yz_sum
  ...
  integer :: ijk
#endif
  type(c_ptr) :: displ_p,veloc_p,dummyx_loc_p,dummyy_loc_p,dummyz_loc_p
  type(c_ptr) :: duxdxl_p,duxdyl_p,duxdzl_p,duydxl_p,duydyl_p,duydzl_p,duzdxl_p,duzdyl_p,duzdzl_p
  type(c_ptr) :: stress_xx_p,stress_yy_p,stress_zz_p,stress_xy_p,stress_xz_p,stress_yz_p
  type(c_ptr) :: xixl_p,xiyl_p,xizl_p,etaxl_p,etayl_p,etazl_p,gammaxl_p,gammayl_p,gammazl_p,jacobianl_p
  type(c_ptr) :: tempx1_p,tempx2_p,tempx3_p,tempy1_p,tempy2_p,tempy3_p,tempz1_p,tempz2_p,tempz3_p
  type(c_ptr) :: c11_p,c12_p,c13_p,c14_p,c15_p,c16_p,c22_p,c23_p,c24_p,c25_p,c26_p,c33_p,c34_p,c35_p,c36_p,&
            c44_p,c45_p,c46_p,c55_p,c56_p,c66_p
  type(c_ptr) :: R_trace_kappa_sum_p,R_xx_sum_p,R_yy_sum_p,R_xy_sum_p,R_xz_sum_p,R_yz_sum_p,kappal_p,mul_p
  type(c_ptr) :: newtempx1_p,newtempx2_p,newtempx3_p,newtempy1_p,newtempy2_p,newtempy3_p,newtempz1_p,newtempz2_p,newtempz3_p
  type(c_ptr) :: hprime_xx_p,hprime_xxT_p,hprimewgll_xxT_p,hprimewgll_xx_p 
  logical(1) :: ATTENUATION_c,ANISOTROPY_c,MOVIE_VOLUME_STRESS_c
  logical(1) :: is_CPML_c
...
!$OMP ) &
!$OMP PRIVATE( &
!$OMP ispec_p,ispec,ispec_irreg,i,j,k,l,iglob,ispec2D, hprime_xx_p,hprime_xxT_p,hprimewgll_xxT_p,hprimewgll_xx_p,&
#ifdef FORCE_VECTORIZATION
!$OMP ijk, &
#endif
!$OMP xixl,xiyl,xizl,etaxl,etayl,etazl,gammaxl,gammayl,gammazl,jacobianl,eta, &
!$OMP xixl_p,xiyl_p,xizl_p,etaxl_p,etayl_p,etazl_p,gammaxl_p,gammayl_p,gammazl_p,jacobianl_p, &
!$OMP duxdxl,duxdyl,duxdzl,duydxl,duydyl,duydzl,duzdxl,duzdyl,duzdzl, &
!$OMP duxdxl_p,duxdyl_p,duxdzl_p,duydxl_p,duydyl_p,duydzl_p,duzdxl_p,duzdyl_p,duzdzl_p, &
!$OMP stress_xx_p,stress_yy_p,stress_zz_p,stress_xy_p,stress_xz_p,stress_yz_p, &
...
!$OMP c11_p,c12_p,c13_p,c14_p,c15_p,c16_p,c22_p,c23_p,c24_p,c25_p,c26_p,c33_p,c34_p,c35_p,c36_p,&
!$OMP c44_p,c45_p,c46_p,c55_p,c56_p,c66_p,&
!$OMP lambdal,mul,mul_p,lambdalplus2mul,kappal,kappal_p, &
!$OMP hp1,hp2,hp3,fac1,fac2,fac3, &
!$OMP dummyx_loc,dummyy_loc,dummyz_loc,dummyx_loc_p,dummyy_loc_p,dummyz_loc_p,&
!$OMP tempx1,tempx2,tempx3,tempy1,tempy2,tempy3,tempz1,tempz2,tempz3, &
!$OMP tempx1_p,tempx2_p,tempx3_p,tempy1_p,tempy2_p,tempy3_p,tempz1_p,tempz2_p,tempz3_p, &
!$OMP newtempx1,newtempx2,newtempx3,newtempy1,newtempy2,newtempy3,newtempz1,newtempz2,newtempz3, &
!$OMP newtempx1_p,newtempx2_p,newtempx3_p,newtempy1_p,newtempy2_p,newtempy3_p,newtempz1_p,newtempz2_p,newtempz3_p, &
...
!$OMP R_trace_kappa_sum,R_xx_sum,R_yy_sum,R_xy_sum,R_xz_sum,R_yz_sum,templ, &
!$OMP R_trace_kappa_sum_p,R_xx_sum_p,R_yy_sum_p,R_xy_sum_p,R_xz_sum_p,R_yz_sum_p, &
!$OMP ATTENUATION_c,ANISOTROPY_c,is_CPML_c,MOVIE_VOLUME_STRESS_c &
!$OMP ) &
!$OMP FIRSTPRIVATE( &
...
!$OMP DO
  do ispec_p = 1,num_elements
   ...
   ! stores displacement values in local array
      ...
      do k=1,NGLLZ
        do j=1,NGLLY
          do i=1,NGLLX
            ...
            veloc_p=c_loc(veloc(1,iglob))
            displ_p=c_loc(displ(1,iglob))
            dummyx_loc_p=c_loc(dummyx_loc(i,j,k))
            dummyy_loc_p=c_loc(dummyy_loc(i,j,k))
            dummyz_loc_p=c_loc(dummyz_loc(i,j,k))
            call dumm_loc_simd(displ_p,eta,veloc_p,dummyx_loc_p,dummyy_loc_p,dummyz_loc_p)
          enddo
        enddo
      enddo
    else
    ...
    select case (NGLLX)
    case (5)
      hprime_xx_p = c_loc(hprime_xx(1,1))

      hprime_xxT_p = c_loc(hprime_xxT(1,1))
      tempx1_p=c_loc(tempx1(1,1,1))
      tempy1_p=c_loc(tempy1(1,1,1))
      tempz1_p=c_loc(tempz1(1,1,1))
      tempx2_p=c_loc(tempx2(1,1,1))
      tempy2_p=c_loc(tempy2(1,1,1))
      tempz2_p=c_loc(tempz2(1,1,1))
      tempx3_p=c_loc(tempx3(1,1,1))
      tempy3_p=c_loc(tempy3(1,1,1))
      tempz3_p=c_loc(tempz3(1,1,1))
      dummyx_loc_p=c_loc(dummyx_loc(1,1,1))
      dummyy_loc_p=c_loc(dummyy_loc(1,1,1))
      dummyz_loc_p=c_loc(dummyz_loc(1,1,1))
      call mxm5_3comp_singleA_simd(hprime_xx_p,m1,dummyx_loc_p,dummyy_loc_p,dummyz_loc_p,tempx1_p,tempy1_p,tempz1_p,m2)
      call mxm5_3comp_3dmat_single_simd(dummyx_loc_p,dummyy_loc_p,dummyz_loc_p,m1,hprime_xxT_p,m1,tempx2_p,tempy2_p,tempz2_p,m1)
      !call mxm5_3comp_3dmat_single(dummyx_loc,dummyy_loc,dummyz_loc,m1,hprime_xxT,m1,tempx2,tempy2,tempz2,m1)
      call mxm5_3comp_singleB_simd(dummyx_loc_p,dummyy_loc_p,dummyz_loc_p,m2,hprime_xxT_p,tempx3_p,tempy3_p,tempz3_p,m1)
    case (6)
      ...
      if (ATTENUATION .and. .not. is_CPML(ispec)) then
        ...
        do k=1,NGLLZ
          do j=1,NGLLY
            do i=1,NGLLX
              iglob = ibool(i,j,k,ispec)
              dummyx_loc_p=c_loc(dummyx_loc_att(i,j,k))
              dummyy_loc_p=c_loc(dummyy_loc_att(i,j,k))
              dummyz_loc_p=c_loc(dummyz_loc_att(i,j,k))
              veloc_p=c_loc(veloc(1,iglob))
              call dumm_loc_simd_2(deltat,veloc_p,dummyx_loc_p,dummyy_loc_p,dummyz_loc_p) 
            enddo
          enddo
        enddo
    ...
    if (ispec_irreg /= 0) then
      ! irregular element
        xixl_p = c_loc(xixstore(1,1,1,ispec_irreg))
        xiyl_p = c_loc(xiystore(1,1,1,ispec_irreg))
        xizl_p = c_loc(xizstore(1,1,1,ispec_irreg))
        etaxl_p = c_loc(etaxstore(1,1,1,ispec_irreg))
        etayl_p = c_loc(etaystore(1,1,1,ispec_irreg))
        etazl_p = c_loc(etazstore(1,1,1,ispec_irreg))
        gammaxl_p = c_loc(gammaxstore(1,1,1,ispec_irreg))
        gammayl_p = c_loc(gammaystore(1,1,1,ispec_irreg))
        gammazl_p = c_loc(gammazstore(1,1,1,ispec_irreg))

        duxdxl_p=c_loc(duxdxl(1,1,1))
        duxdyl_p=c_loc(duxdyl(1,1,1))
        duxdzl_p=c_loc(duxdzl(1,1,1))
        tempx1_p=c_loc(tempx1(1,1,1))
        tempx2_p=c_loc(tempx2(1,1,1))
        tempx3_p=c_loc(tempx3(1,1,1))

        duydxl_p=c_loc(duydxl(1,1,1))
        duydyl_p=c_loc(duydyl(1,1,1))
        duydzl_p=c_loc(duydzl(1,1,1))
        tempy1_p=c_loc(tempy1(1,1,1))
        tempy2_p=c_loc(tempy2(1,1,1))
        tempy3_p=c_loc(tempy3(1,1,1))

        duzdxl_p=c_loc(duzdxl(1,1,1))
        duzdyl_p=c_loc(duzdyl(1,1,1))
        duzdzl_p=c_loc(duzdzl(1,1,1))
        tempz1_p=c_loc(tempz1(1,1,1))
        tempz2_p=c_loc(tempz2(1,1,1))
        tempz3_p=c_loc(tempz3(1,1,1))
        call du_simd(xixl_p,xiyl_p,xizl_p,etaxl_p,etayl_p,etazl_p,gammaxl_p,gammayl_p,gammazl_p,&
                tempx1_p,tempx2_p,tempx3_p,duxdxl_p,duxdyl_p,duxdzl_p,tempy1_p,tempy2_p,tempy3_p,&
                duydxl_p,duydyl_p,duydzl_p,tempz1_p,tempz2_p,tempz3_p,duzdxl_p,duzdyl_p,duzdzl_p)
    else
      ! regular element
      DO_LOOP_IJK
    ...
    c11_p = c_loc(c11store(1,1,1,ispec))
    c12_p = c_loc(c12store(1,1,1,ispec))
    c13_p = c_loc(c13store(1,1,1,ispec))
    c14_p = c_loc(c14store(1,1,1,ispec))
    c15_p = c_loc(c15store(1,1,1,ispec))
    c16_p = c_loc(c16store(1,1,1,ispec))
    c22_p = c_loc(c22store(1,1,1,ispec))
    c23_p = c_loc(c23store(1,1,1,ispec))
    c24_p = c_loc(c24store(1,1,1,ispec))
    c25_p = c_loc(c25store(1,1,1,ispec))
    c26_p = c_loc(c26store(1,1,1,ispec))
    c33_p = c_loc(c33store(1,1,1,ispec))
    c34_p = c_loc(c34store(1,1,1,ispec))
    c35_p = c_loc(c35store(1,1,1,ispec))
    c36_p = c_loc(c36store(1,1,1,ispec))
    c44_p = c_loc(c44store(1,1,1,ispec))
    c45_p = c_loc(c45store(1,1,1,ispec))
    c46_p = c_loc(c46store(1,1,1,ispec))
    c55_p = c_loc(c55store(1,1,1,ispec))
    c56_p = c_loc(c56store(1,1,1,ispec))
    c66_p = c_loc(c66store(1,1,1,ispec))
    
    stress_xx_p=c_loc(stress_xx(1,1,1,ispec))
    stress_yy_p=c_loc(stress_yy(1,1,1,ispec))
    stress_zz_p=c_loc(stress_zz(1,1,1,ispec))
    stress_xy_p=c_loc(stress_xy(1,1,1,ispec))
    stress_xz_p=c_loc(stress_xz(1,1,1,ispec))
    stress_yz_p=c_loc(stress_yz(1,1,1,ispec))
     
    kappal_p = c_loc(kappastore(1,1,1,ispec))
    mul_p = c_loc(mustore(1,1,1,ispec))
    ...
    DO_LOOP_IJK
    if (ATTENUATION .and. .not. is_CPML(ispec)) then
        R_xx_sum(INDEX_IJK) = sum(R_xx(:,INDEX_IJK,ispec))
        R_yy_sum(INDEX_IJK) = sum(R_yy(:,INDEX_IJK,ispec))
        R_xy_sum(INDEX_IJK) = sum(R_xy(:,INDEX_IJK,ispec))
        R_xz_sum(INDEX_IJK) = sum(R_xz(:,INDEX_IJK,ispec))
        R_yz_sum(INDEX_IJK) = sum(R_yz(:,INDEX_IJK,ispec))
        R_trace_kappa_sum(INDEX_IJK) = sum(R_trace(:,INDEX_IJK,ispec))
    endif
    ENDDO_LOOP_IJK
    R_xx_sum_p=c_loc(R_xx_sum(1,1,1))
    R_yy_sum_p=c_loc(R_yy_sum(1,1,1))
    R_xy_sum_p=c_loc(R_xy_sum(1,1,1))
    R_xz_sum_p=c_loc(R_xz_sum(1,1,1))
    R_yz_sum_p=c_loc(R_yz_sum(1,1,1))
    R_trace_kappa_sum_p=c_loc(R_trace_kappa_sum(1,1,1))
    jacobianl_p = c_loc(jacobianstore(1,1,1,ispec_irreg))
    if (ATTENUATION .eqv. .true.) then
        ATTENUATION_c = .true.
    else
        ATTENUATION_c = .false.
    endif
    ...
    if (ANISOTROPY .eqv. .true.) then
        ANISOTROPY_c = .true.
    else
        ANISOTROPY_c = .false.
    endif
    if (MOVIE_VOLUME_STRESS .eqv. .true.) then
        MOVIE_VOLUME_STRESS_c = .true.
    else
        MOVIE_VOLUME_STRESS_c = .false.
    endif
    call stresses_simd(c11_p,c12_p,c13_p,c14_p,c15_p,c16_p,c22_p,c23_p,c24_p,c25_p,c26_p,c33_p,c34_p,c35_p,c36_p,&
            c44_p,c45_p,c46_p,c55_p,c56_p,c66_p,duxdyl_p,duydxl_p,duzdxl_p,duxdzl_p,duzdyl_p,duydzl_p,duxdxl_p,&
            duydyl_p,duzdzl_p,kappal_p,mul_p,FOUR_THIRDS,R_xx_sum_p,R_yy_sum_p,R_trace_kappa_sum_p,R_xy_sum_p,R_xz_sum_p,&
            R_yz_sum_p,ATTENUATION_c,ANISOTROPY_c,is_CPML_c,MOVIE_VOLUME_STRESS_c,stress_xx_p,stress_yy_p,stress_zz_p,&
            stress_xy_p,stress_xz_p,stress_yz_p,ispec_irreg,xixl_p,xiyl_p,xizl_p,etaxl_p,etayl_p,etazl_p,gammaxl_p,&
            gammayl_p,gammazl_p,jacobianl_p,tempx1_p,tempx2_p,tempx3_p,tempy1_p,tempy2_p,tempy3_p,tempz1_p,tempz2_p,&
            tempz3_p,jacobian_regular,xix_regular)
    ! stresses
    ...
    select case (NGLLX)
    case (5)
      hprimewgll_xxT_p = c_loc(hprimewgll_xxT(1,1))
      hprimewgll_xx_p = c_loc(hprimewgll_xx(1,1))
      newtempx1_p = c_loc(newtempx1(1,1,1))
      newtempy1_p = c_loc(newtempy1(1,1,1))
      newtempz1_p = c_loc(newtempz1(1,1,1))
      newtempx2_p = c_loc(newtempx2(1,1,1))
      newtempy2_p = c_loc(newtempy2(1,1,1))
      newtempz2_p = c_loc(newtempz2(1,1,1))
      newtempx3_p = c_loc(newtempx3(1,1,1))
      newtempy3_p = c_loc(newtempy3(1,1,1))
      newtempz3_p = c_loc(newtempz3(1,1,1))
      call mxm5_3comp_singleA_simd(hprimewgll_xxT_p,m1,tempx1_p,tempy1_p,tempz1_p,newtempx1_p,newtempy1_p,newtempz1_p,m2)
      call mxm5_3comp_3dmat_single(tempx2,tempy2,tempz2,m1,hprimewgll_xx,m1,newtempx2,newtempy2,newtempz2,m1)
      call mxm5_3comp_singleB_simd(tempx3_p,tempy3_p,tempz3_p,m2,hprimewgll_xx_p,newtempx3_p,newtempy3_p,newtempz3_p,m1)
...
!$OMP ATOMIC
      ...
      enddo
    enddo
!    wgllwgll_yz_3D_p=c_loc(wgllwgll_yz_3D(1,1,1))
!    wgllwgll_xz_3D_p=c_loc(wgllwgll_xz_3D(1,1,1))
!    wgllwgll_xy_3D_p=c_loc(wgllwgll_xy_3D(1,1,1))
!    newtempx1_p=c_loc(newtempx1(1,1,1))
!    newtempx2_p=c_loc(newtempx2(1,1,1))
!    newtempx3_p=c_loc(newtempx3(1,1,1))
!    newtempy1_p=c_loc(newtempy1(1,1,1))
...
!    newtempz2_p=c_loc(newtempz2(1,1,1))
!    newtempz3_p=c_loc(newtempz3(1,1,1))
!    iglob_p=c_loc(ibool(1,1,1,ispec))
!    
!
!    call accel_simd()
...
!DIR$ SIMD
    ...
    enddo
  enddo
!  call mxm5_3comp_singleA_simd(n1,n3,A_p,B1_p,B2_p,B3_p,C1_p,C2_p,C3_p)
